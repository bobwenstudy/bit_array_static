...
#define TEST_ARRAY_CHECK(arr, size, exp_value) \
    ASSERT(memcmp(bit_array_to_str_8((arr), (size), test_str_buf), (exp_value), strlen(exp_value)) == 0);
...
static void test_assign(void)
{
    ...
    TEST_ARRAY_CHECK(test_bit_array, TEST_BIT_ARRAY_TOTAL, "00010000 10000000 01000000 00000000 00010000 10000000 0100");
...
static void test_set_clear(void)
{
    ...
    TEST_ARRAY_CHECK(test_bit_array, TEST_BIT_ARRAY_TOTAL, "01010000 10000000 01000000 00000000 01010000 10000000 0100");
...
static void test_toggle(void)
{
    ...
    // Toggle all
    bit_array_from_str(test_bit_array, "01010000 10000000 01000000 00000000 01010000 10000000 0101");
    bit_array_toggle_all(test_bit_array, TEST_BIT_ARRAY_TOTAL);
    TEST_ARRAY_CHECK(test_bit_array, TEST_BIT_ARRAY_TOTAL, "10101111 01111111 10111111 11111111 10101111 01111111 1010");
    ...
    TEST_ARRAY_CHECK(test_bit_array, TEST_BIT_ARRAY_TOTAL, "00000000 00000000 00000000 00000000 00000000 00000000 0000");
...
static void test_copy(void)
{
    ...
    TEST_ARRAY_CHECK(tmp_array, TEST_BIT_ARRAY_TOTAL, "01010000 10000000 01000000 00000000 01010000 10000000 0101");



    bit_array_clear_all(tmp_array, TEST_BIT_ARRAY_TOTAL);
    bit_array_copy(tmp_array, 0, test_bit_array, 0, TEST_BIT_ARRAY_TOTAL, TEST_BIT_ARRAY_TOTAL, TEST_BIT_ARRAY_TOTAL);
    TEST_ARRAY_CHECK(tmp_array, TEST_BIT_ARRAY_TOTAL, "01010000 10000000 01000000 00000000 01010000 10000000 0101");

    bit_array_clear_all(tmp_array, TEST_BIT_ARRAY_TOTAL);
    bit_array_copy(tmp_array, 4, test_bit_array, 0, TEST_BIT_ARRAY_TOTAL - 4, TEST_BIT_ARRAY_TOTAL, TEST_BIT_ARRAY_TOTAL);
    TEST_ARRAY_CHECK(tmp_array, TEST_BIT_ARRAY_TOTAL, "00000101 00001000 00000100 00000000 00000101 00001000 0000");

    bit_array_clear_all(tmp_array, TEST_BIT_ARRAY_TOTAL);
    bit_array_copy(tmp_array, 32, test_bit_array, 0, TEST_BIT_ARRAY_TOTAL - 32, TEST_BIT_ARRAY_TOTAL, TEST_BIT_ARRAY_TOTAL);
    TEST_ARRAY_CHECK(tmp_array, TEST_BIT_ARRAY_TOTAL, "00000000 00000000 00000000 00000000 01010000 10000000 0100");
...
static void test_logic(void)
{
    ...
    TEST_ARRAY_CHECK(tmp_array, TEST_BIT_ARRAY_TOTAL, "01010000 10000000 01000000 00000000 00010000 10000000 0100");

    // Test or
    bit_array_clear_all(tmp_array, TEST_BIT_ARRAY_TOTAL);
    bit_array_from_str(tmp_array, "01011111 10000110 01000000 01101000 00010110 10001100 0100");
    bit_array_or(tmp_array, tmp_array, test_bit_array, TEST_BIT_ARRAY_TOTAL);
    TEST_ARRAY_CHECK(tmp_array, TEST_BIT_ARRAY_TOTAL, "01011111 10000110 01000000 01101000 01010110 10001100 0101");

    // Test xor
    bit_array_clear_all(tmp_array, TEST_BIT_ARRAY_TOTAL);
    bit_array_from_str(tmp_array, "01011111 10000110 01000000 01101000 00010110 10001100 0100");
    bit_array_xor(tmp_array, tmp_array, test_bit_array, TEST_BIT_ARRAY_TOTAL);
    TEST_ARRAY_CHECK(tmp_array, TEST_BIT_ARRAY_TOTAL, "00001111 00000110 00000000 01101000 01000110 00001100 0001");

    // Test not
    bit_array_clear_all(tmp_array, TEST_BIT_ARRAY_TOTAL);
    bit_array_not(tmp_array, test_bit_array, TEST_BIT_ARRAY_TOTAL);
    TEST_ARRAY_CHECK(tmp_array, TEST_BIT_ARRAY_TOTAL, "10101111 01111111 10111111 11111111 10101111 01111111 1010");
...
static void test_shift(void)
{
    ...
    TEST_ARRAY_CHECK(tmp_array, TEST_BIT_ARRAY_TOTAL, "00001000 00000100 00000000 00000101 00001000 00000101 1111");
    
    bit_array_copy_all(tmp_array, test_bit_array, TEST_BIT_ARRAY_TOTAL);
    bit_array_shift_right(tmp_array, TEST_BIT_ARRAY_TOTAL, 12, 0);
    TEST_ARRAY_CHECK(tmp_array, TEST_BIT_ARRAY_TOTAL, "00000100 00000000 00000101 00001000 00000101 00000000 0000");

    // Test shift left
    bit_array_copy_all(tmp_array, test_bit_array, TEST_BIT_ARRAY_TOTAL);
    bit_array_shift_left(tmp_array, TEST_BIT_ARRAY_TOTAL, 4, 1);
    TEST_ARRAY_CHECK(tmp_array, TEST_BIT_ARRAY_TOTAL, "11110101 00001000 00000100 00000000 00000101 00001000 0000");
    
    bit_array_copy_all(tmp_array, test_bit_array, TEST_BIT_ARRAY_TOTAL);
    bit_array_shift_left(tmp_array, TEST_BIT_ARRAY_TOTAL, 12, 0);
    TEST_ARRAY_CHECK(tmp_array, TEST_BIT_ARRAY_TOTAL, "00000000 00000101 00001000 00000100 00000000 00000101 0000");
